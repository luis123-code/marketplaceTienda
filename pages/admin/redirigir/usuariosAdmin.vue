    ...
    <div>
        <div style=" display: flex;margin: 48px 39px;justify-content: space-between;">
                <div style="display: flex; ">
                    <AnimatedText :text="'Usuarios'" /><img style="height: 33px;position: relative;bottom: -11px;right: -12px;" src="../../../static/icons/users.svg" />
                </div>
        ...
        <div style="margin: 25px 43px;">
            <tableAdmi  :tableDinami="'Usuarios'"  ></tableAdmi>
        </div>
    </div>
</template>
<script>
